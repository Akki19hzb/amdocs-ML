...
from config import Sachin_config,Kohli_config
...
# Just change the config file in below line to make new model.
config_file=Sachin_config

data_pkl_name=config_file.data_pkl_name
model_pkl_name=config_file.name_of_model

excel_file_name=config_file.name_of_excel

lable_encoder_name=config_file.label_encoder_name
